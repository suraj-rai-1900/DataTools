...
out_fpath="/home/amisery/scratch/outputs_h5_combined/iwcd_p320ka_w750m_1e17pot_2p39_wcsim_combined.h5"

python /home/surajrai/DataTools/root_utils/np_to_digihit_array_hdf5.py "${input_files[@]}" -o "$out_fpath"
